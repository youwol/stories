...
[Developers documentation](https://platform.youwol.com/applications/@youwol/cdn-explorer/latest?package=@youwol/stories&tab=doc)
    ...
    customization = Customization(
        middlewares = [
            FlowSwitcherMiddleware(
                ...
                oneOf = [
                    WebpackDevServerSwitch(packageName="@youwol/stories", port=3001),
                ]
            )
        ]
    )
...
the application can be accessed from [here](http://localhost:2000/applications/@youwol/stories/latest)
